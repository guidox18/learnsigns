...
<?php 
$action = "action/mensaje_actualizar.php";
if($db->DetallarWeb()){	
...
?>
		...
		<div class="form_gestion">
			<section>
				<h2>Gestionar Mensaje</h2>
			</section>
			<form action="<?php echo $action; ?>" method="POST" enctype="multipart/form-data">
				<div class="frm_izquierda">
					<label for="">Titulo:</label>
					<input type="text" name="Mensaje1" value="<?php echo $mensaje1 ;?>"required>
				</div>
				<div class="frm_derecha">
					<label for="">Sub Titulo:</label>
					<textarea name="Mensaje2"  ><?php echo $mensaje2 ;?></textarea>
				</div>
