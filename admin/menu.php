...
<nav class="nav_c2">
   ...
   <div class="responsive_items">
      <a class="nav_item" href="web.php" >Web</a>  
      <a class="nav_item"  href="usuarios.php" >Usuarios</a>   
      <a class="nav_item" href="curso_administrador.php" >Curso</a>  
      <a class="nav_item" href="evaluacion_administrador.php" >Evaluaciones</a>  
   </div>
	...
	<ul class="user">
      ...
      <ul class="sub-items">        
            <!--<li><a href="#"><span class="icon-items icon-usu"></span>Perfil</a></li>-->
