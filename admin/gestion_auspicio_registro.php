...
switch ($gestion) {
	case "agregar":
		$action = "action/auspicio_agregar.php";
		$titulo = "Registrar Auspicio";
		//valores
		$idx="";
		$nombrex="";
		$imagenx="";
	...
	break;
	case "actualizar":
		$action = "action/auspicio_actualizar.php";
		$titulo = "Actualizar Auspicio";
		$idx = $_GET["idx"];

		if($db->DetallarAuspicio($idx ))
		{	
			$result = $db->DetallarAuspicio($idx );
		...
		<div class="form_gestion">
			...
			<form action="<?php echo $action; ?>" method="POST" enctype="multipart/form-data">
				...
				<div class="frm_derecha">
					...
					<div class="img_form">
						<img  id="imgSalida" src="<?php if ($gestion=="agregar") {echo "../img/error_2.jpg";}
						else{echo"../img/auspicio/"."$imagenx";}?>" 
						alt="">
					</div>
				</div>
