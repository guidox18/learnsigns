	...
	<div id="contenedor2">
		...
		<div class="cont_ctrl_gestion">
			<div class="ctrl_gestion">
				...
				<section>
					<a class="optionx" href="gestion_articulo_registro.php?gestion=agregar">
						<span  class="op_usuarios icon-items icon-articulo"></span>
						<label>Articulo</label>
					</a>
					<a class="optionx" href="reporte.php?tipo=listararticulos">
			...
			<div class="buscar">
				<form id="form" name="fo3" action="buscar.php" method="POST" >
				    ...
				    <input type="hidden" name="tipobuscar" value="articulo"/>
				</form>
			</div>
		</div>
